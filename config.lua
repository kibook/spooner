...
Config.SpawnSelectControl = 0x9D2AEA88 -- Left mouse button
...
Config.AdjustNorthControl = 0x6319DB71 -- Up arrow key
Config.AdjustSouthControl = 0x05CA7C52 -- Down arrow key
Config.AdjustEastControl = 0xA65EBAB4 -- Left arrow key
Config.AdjustWestControl = 0xDEB34313 -- Right arrow key
Config.RotateRightControl = 0xD8CF0C95 -- C
Config.RotateLeftControl = 0x7F8D09B8 -- V
Config.RotateModeControl = 0x4CC0E2FE -- B
Config.ObjectMenuControl = 0xB2F377E8 -- F
Config.DbMenuControl = 0x827E9EE8 -- X
Config.PropMenuControl = 0x43DBF61F -- Enter
Config.SaveLoadDbMenuControl = 0xF3830D8E -- J
Config.AdjustModeControl = 0xC1989F95 -- I
Config.ResetAdjustModeControl = 0xD8F73058 -- U
